...
export default function AdminDashboardScreen() {
  ...
  // carrega as estatísticas ao abrir a tela
  useEffect(() => {
  ...
  // data de hoje formatada dinamicamente
  ...
  // dia da semana por extenso com primeira letra maiúscula
      ...
      <View style={styles.page}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.header}>
            ...
            {isDesktop && (
              <View style={styles.userArea}>
                ...
                {/* caixa de data atual — gerada dinamicamente */}
          ...
          <View style={styles.sectionCard}>
            ...
            <View style={[styles.statsGrid, isDesktop && styles.statsGridDesktop]}>
              ...
              <View style={styles.statCard}>
                ...
                {/* número real de agendamentos vindo do banco */}
                <View>
          ...
          <View style={styles.sectionCard}>
            ...
            {/* lista das últimas consultas registradas no banco */}
            <View style={styles.activityList}>

              {/* mensagem quando ainda não há nenhuma consulta cadastrada */}
              {(!stats?.atividadesRecentes || stats.atividadesRecentes.length === 0) && (
                <View style={{ padding: 20 }}>
                  <Text style={{ color: '#6B7C86', fontSize: 13 }}>
              ...
              {(stats?.atividadesRecentes ?? []).map((item: any, index: number) => {
                ...
                return (
                  <View
                    key={item.id ?? index}
                    style={isLast ? styles.activityItemLast : styles.activityItem}
                  >
                    {/* ícone muda cor conforme o status da consulta */}
                    {isCancelado ? (
                    ...
                    <View style={styles.activityInfo}>
                      <Text style={styles.activityTitle}>
                        {isCancelado ? 'Agendamento cancelado' : 'Agendamento registrado'}
                      </Text>
                      <Text style={styles.activityText}>
                        {item.paciente ?? 'Paciente'} — {dataFormatada} às {item.horario}
                      </Text>
                    </View>
