        ...
        {isDesktop && (
          <View style={styles.sidebar}>
            ...
            <View style={styles.menuArea}>
              ...
              {/* item de menu: pedidos de reagendamento */}
              <TouchableOpacity
                style={styles.menuItem}
              ...
              {/* item de menu: relatório de atendimentos */}
              <TouchableOpacity
                style={styles.menuItem}
          ...
          <View style={styles.wrapper}>
            ...
            <View style={[styles.card, isDesktop && styles.cardDesktop]}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.85}
                onPress={() => {
                  // salva o tipo de conta selecionado no contexto antes de avançar
                  atualizarDadosCadastro({ tipo: tipoUsuario });
